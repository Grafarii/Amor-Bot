...
| Constructo | Característica central | Relação com confabulação virtual |
|---|---|---|
| Falsa memória | Recordação de evento inexistente ou distorcido | Categoria ampla; confabulação virtual é subtipo mediado por RV |
...
A RV é usada em protocolos de exposição para fobias, transtorno de estresse pós-traumático e reabilitação cognitiva (Maples-Keller et al., 2017). Sua eficácia relaciona-se, em parte, à simulação convincente de experiências vividas. Essa mesma propriedade implica risco de confabulação virtual: memórias de exposições simuladas podem ser posteriormente recordadas como eventos traumáticos ou corretivos reais, com consequências imprevisíveis para a auto-narrativa do paciente. Protocolos clínicos poderiam incluir debriefing estruturado e registro externo da condição virtual, procedimentos ainda pouco padronizados.
...
**Variáveis independentes:** modalidade de exposição (RV, vídeo, texto); nível de presença (Slater-Usoh-Steed Presence Questionnaire); intensidade emocional autorrelatada.
...
Trata-se de artigo teórico. Nenhum participante humano ou animal esteve envolvido. Portanto, não foi necessária aprovação de comitê de ética em pesquisa.
